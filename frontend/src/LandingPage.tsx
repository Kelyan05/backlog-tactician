function KnapsackIcon() {
  return (
    <svg width="56" height="56" viewBox="0 0 122 138" fill="none" aria-hidden="true">
      <rect x="10" y="38" width="100" height="90" rx="18" stroke="var(--accent)" strokeWidth="6" />
      <path d="M32 22 q28 -20 56 0 v20 h-56 z" stroke="var(--accent)" strokeWidth="6" strokeLinejoin="round" />
      <rect x="40" y="70" width="40" height="30" rx="8" fill="var(--accent)" fillOpacity="0.85" />
      <line x1="34" y1="38" x2="34" y2="52" stroke="var(--accent)" strokeWidth="6" strokeLinecap="round" />
      <line x1="86" y1="38" x2="86" y2="52" stroke="var(--accent)" strokeWidth="6" strokeLinecap="round" />
    </svg>
  )
}
      ...
      <div className="landing">
        <header className="landing-hero">
          ...
          <p className="landing-sub">
            Every gamer has 40+ unplayed games and no idea what to actually play next. This models
            that as a <strong>0/1 knapsack problem</strong> instead of a plain list.
          </p>
          ...
          {import.meta.env.DEV && (
            <div className="dev-login">
              <button
                type="button"
                onClick={() => {
                  fetch('/auth/dev-login', { method: 'POST', credentials: 'include' }).then(() =>
        ...
        <footer className="landing-footer">
          <a href="https://github.com/Kelyan05/backlog-tactician" target="_blank" rel="noreferrer">
            GitHub
          </a>
          <span aria-hidden="true">·</span>
          <a href="https://github.com/Kelyan05/backlog-tactician/blob/main/openapi.yaml" target="_blank" rel="noreferrer">
            API reference
          </a>
          <span aria-hidden="true">·</span>
          <a href="https://github.com/Kelyan05/backlog-tactician/blob/main/docs/scheduling.md" target="_blank" rel="noreferrer">
